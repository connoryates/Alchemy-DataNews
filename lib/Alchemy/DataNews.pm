...
sub get_return_fields {
    ...
    return {
        ...
        image_keyword                      => 'enriched.url.imageKeyword.text',                               # Text
        ...
        keyword                            => 'enriched.url.keywords.keyword.text',                           # Text
        keyword_relevance                  => 'enriched.url.keywords.keyword.relevance',                      # Float
        keyword_sentiment_type             => 'enriched.url.keywords.keyword.sentiment.type',                 # Text
        keyword_sentiment_score            => 'enriched.url.keywords.keyword.sentiment.score',                # Float
        keyword_sentiment_mixed            => 'enriched.url.keywords.keyword.sentiment.mixed',                # Unsigned Int
        keyword_hierarchy                  => 'enriched.url.keywords.keyword.knowledgeGraph.typeHierarchy',   # Text
        keywords_titles                    => 'enriched.url.enrichedTitle.keywords',                          # Array
        keyword_title                      => 'enriched.url.enrichedTitle.keywords.keyword.text',             # Text
        keyword_title_relevance            => 'enriched.url.enrichedTitle.keywords.keyword.relevance',        # Float
        keyword_title_sentiment_type       => 'enriched.url.enrichedTitle.keywords.keyword.sentiment.type',   # Text
        keyword_title_sentiment_score      => 'enriched.url.enrichedTitle.keywords.keyword.sentiment.score',  # Float
        keyword_title_sentiment_mixed      => 'enriched.url.enrichedTitle.keywords.keyword.sentiment.mixed',  # Unsigned Int
        keyword_title_hierarchy            => 'enriched.url.enrichedTitle.keywords.keyword.knowledgeGraph.typeHierarchy', # Text
        entities                           => 'enriched.url.entities',                                        # Array
        entity                             => 'enriched.url.entities.entity.text',                            # Text
        ...
        entity_titles                      => 'enriched.url.enrichedTitle.entities',                           # Array
        entity_title                       => 'enriched.url.enrichedTitle.entity.text',                        # Text
        entity_title_type                  => 'enriched.url.enrichedTitle.entity.type',                        # Text
        entity_title_hierarchy             => 'enriched.url.enrichedTitle.entities.entity.knowledgeGraph.typeHierarchy', # Text
        entity_title_count                 => 'enriched.url.enrichedTitle.entities.entity.count',              # Unsigned Int
        entity_title_relevance             => 'enriched.url.enrichedTitle.entities.entity.relevance',          # Float
        entity_title_sentiment_type        => 'enriched.url.enrichedTitle.entities.entity.sentiment.type',     # Text
        entity_title_sentiment_score       => 'enriched.url.enrichedTitle.entities.entity.sentiment.score',    # Float
        entity_title_sentiment_mixed       => 'enriched.url.enrichedTitle.entities.entity.sentiment.mixed',    # Unsigned Int
        entity_title_disambig_name         => 'enriched.url.enrichedTitle.entities.entity.disambiguated.name', # Text
        entity_title_disambig_geo          => 'enriched.url.enrichedTitle.entities.entity.disambiguated.geo',  # Text
        entity_title_disambig_dbpedia      => 'enriched.url.enrichedTitle.entities.entity.disambiguated.dbpedia',   # Text
        entity_title_disambig_website      => 'enriched.url.enrichedTitle.entities.entity.disambiguated.website',   # Text
        entity_title_disambig_subtypes     => 'enriched.url.enrichedTitle.entities.entity.disambiguated.subTypes',  # Array
        entity_title_disambig_subtype      => 'enriched.url.enrichedTitle.entities.entity.disambiguated.subType',   # Text
        entity_title_quotations            => 'enriched.url.enrichedTitle.entities.entity.quotations',         # Array
        entity_title_quotation             => 'enriched.url.enrichedTitle.entities.entity.quotations.quotation_.quotation',           # Text
        entity_title_quotation_sentiment_type  => 'enriched.url.enrichedTitle.entities.entity.quotations.quotation_.sentiment.type',  # Text
        entity_title_quotation_sentiment_score => 'enriched.url.enrichedTitle.entities.entity.quotations.quotation_.sentiment.score', # Float
        entity_title_quotation_sentiment_mixed => 'enriched.url.enrichedTitle.entities.entity.quotations.quotation_.sentiment.mixed', # Unsigned Int
        concepts                           => 'enriched.url.concepts',                                          # Array
        concept_text                       => 'enriched.url.concepts.concept.text',                             # Text
        concept_titles                     => 'enriched.url.enrichedTitle.concepts',                            # Array
        concept_title                      => 'enriched.url.enrichedTitle.concepts.concept.text',               # Text
        concept_relevance                  => 'enriched.url.concepts.concept.relevance',                        # Float
        concept_title_relevance            => 'enriched.url.enrichedTitle.concepts.concept.relevance',          # Text
        concept_hierarchy                  => 'enriched.url.concepts.concept.knowledgeGraph.typeHierarchy',     # Text
        concept_title_hierarchy            => 'enriched.url.enrichedTitle.concepts.concept.knowledgeGraph.typeHierarchy',  # Text
        relations                          => 'enriched.url.relations',                                         # Array
        relations_title                    => 'enriched.url.enrichedTitle.relations',                           # Array
        relation_sentence                  => 'enriched.url.relations.relation.sentence',                       # Text
        relation_title_sentence            => 'enriched.url.enrichedTitle.relations.relation.sentence',         # Text
        relation_title_subject_entities    => 'enriched.url.enrichedTitle.relations.relation.subject.entities', # Array
        relation_title_subject_entity_text => 'enriched.url.enrichedTitle.relations.relation.subject.entities.entity.text', # Text
        relation_title_subject_entity_type => 'enriched.url.enrichedTitle.relations.relation.subject.entities.entity.type', # Text
        relation_title_subject_entity_hierarchy  => 'enriched.url.enrichedTitle.relations.relation.subject.entities.entity.knowledgeGraph.typeHierarchy', # Text
        relation_title_subect_entity_count       => 'enriched.url.enrichedTitle.relations.relation.subject.entities.entity.count',     # Unsigned Int
        relation_title_subject_entity_relevance  => 'enriched.url.enrichedTitle.relations.relation.subject.entities.entity.relevance', # Float
        relation_title_subject_entity_sentiment_type    => 'enriched.url.enrichedTitle.relations.relation.subject.entities.entity.sentiment.type',        # Text
        relation_title_subject_entity_sentiment_score   => 'enriched.url.enrichedTitle.relations.relation.subject.entities.entity.sentiment.score',       # Float
        relation_title_subject_entity_sentiment_mixed   => 'enriched.url.enrichedTitle.relations.relation.subject.entities.entity.sentiment.mixed',       # Unsigned Int
        relation_title_subject_entity_disambig_name     => 'enriched.url.enrichedTitle.relations.relation.subject.entities.entity.disambiguated.name',    # Text
        relation_title_subject_entity_disambig_geo      => 'enriched.url.enrichedTitle.relations.relation.subject.entities.entity.disambiguated.name',    # Text
        relation_title_subject_entity_disambig_dbpedia  => 'enriched.url.enrichedTitle.relations.relation.subject.entities.entity.disambiguated.dbpedia', # Text
        relation_title_subject_entity_disambig_website  => 'enriched.url.enrichedTitle.relations.relation.subject.entities.entity.disambiguated.website', # Text
        relation_title_subject_entity_disambig_subtypes => 'enriched.url.enrichedTitle.relations.relation.subject.entities.entity.disambiguated.subType',           # Array
        relation_title_subject_entity_disambig_subtype  => 'enriched.url.enrichedTitle.relations.relation.subject.entities.entity.disambiguated.subType.subType_',  # Text
        relation_title_subject_entity_quotations        => 'enriched.url.enrichedTitle.relations.relation.subject.entities.entity.quotations',            # Array
        relation_title_subject_entity_quotation         => 'enriched.url.enrichedTitle.relations.relation.subject.entities.entity.quotations.quotation_.quotation', # Text
        relation_title_subject_entity_quotation_sentiment_type  => 'enriched.url.enrichedTitle.relations.relation.subject.entities.entity.quotations.quotation_.sentiment.type',  # Text
        relation_title_subject_entity_quotation_sentiment_score => 'enriched.url.enrichedTitle.relations.relation.subject.entities.entity.quotations.quotation_.sentiment.score', # Float
        relation_title_subject_entity_quotation_sentiment_mixed => 'enriched.url.enrichedTitle.relations.relation.subject.entities.entity.quotations.quotation_.sentiment.mixed', # Unsigned  Int
        relation_title_subject_keywords                => 'enriched.url.enrichedTitle.relations.relation.subject.keywords',                          # Array
        relation_title_subject_keyword                 => 'enriched.url.enrichedTitle.relations.relation.subject.keywords.keyword.text',             # Text
        relation_title_subject_keyword_relevance       => 'enriched.url.enrichedTitle.relations.relation.subject.keywords.keyword.relevance',        # Float
        relation_title_subject_keyword_sentiment_type  => 'enriched.url.enrichedTitle.relations.relation.subject.keywords.keyword.sentiment.type',   # Text
        relation_title_subject_keyword_sentiment_score => 'enriched.url.enrichedTitle.relations.relation.subject.keywords.keyword.sentiment.score',  # Text 
        relation_title_subject_keyword_sentiment_mixed => 'enriched.url.enrichedTitle.relations.relation.subject.keywords.keyword.sentiment.mixed',  # Text
        relation_title_subject_keyword_hierarchy       => 'enriched.url.enrichedTitle.relations.relation.subject.keywords.keyword.knowledgeGraph.typeHierarchy', # Text
        relation_title_subject_sentiment_type          => 'enriched.url.enrichedTitle.relations.relation.subject.sentiment.type',                    # Text
        relation_title_subject_sentiment_score         => 'enriched.url.enrichedTitle.relations.relation.subject.sentiment.score',                   # Float
        relation_title_subject_sentiment_mixed         => 'enriched.url.enrichedTitle.relations.relation.subject.sentiment.mixed',                   # Unsigned Int
        relation_title_action_text                     => 'enriched.url.enrichedTitle.relations.relation.action.text',                               # Text
        relation_title_action_lemmatized               => 'enriched.url.enrichedTitle.relations.relation.action.lemmatized',                         # Text
        relation_title_action_verb_text                => 'enriched.url.enrichedTitle.relations.relation.action.verb.text',                          # Text
        relation_title_action_verb_tense               => 'enriched.url.enrichedTitle.relations.relation.action.verb.tense',                         # Text
        relation_title_action_verb_negated             => 'enriched.url.enrichedTitle.relations.relation.action.verb.negated',                       # Text
        relation_title_object_text                     => 'enriched.url.enrichedTitle.relations.relation.object.text',                               # Text
        relation_title_object_entities                 => 'enriched.url.enrichedTitle.relations.relation.object.entities',                           # Array
        relation_title_object_entity                   => 'enriched.url.enrichedTitle.relations.relation.object.entities.entity.text',               # Text
        relation_title_object_entity_type              => 'enriched.url.enrichedTitle.relations.relation.object.entities.entity.type',               # Text 
        relation_title_object_entity_hierarchy         => 'enriched.url.enrichedTitle.relations.relation.object.entities.entity.knowledgeGraph.typeHierarchy',   # Text
        relation_title_object_entity_count             => 'enriched.url.enrichedTitle.relations.relation.object.entities.entity.count',              # Unsigned Int
        relation_title_object_entity_relevance         => 'enriched.url.enrichedTitle.relations.relation.object.entities.entity.relevance',          # Float
        relation_title_object_entity_sentiment_type    => 'enriched.url.enrichedTitle.relations.relation.object.entities.entity.sentiment.type',     # Text
        relation_title_object_entity_sentiment_score   => 'enriched.url.enrichedTitle.relations.relation.object.entities.entity.sentiment.score',    # Float
        relation_title_object_entity_sentiment_mixed   => 'enriched.url.enrichedTitle.relations.relation.object.entities.entity.sentiment.mixed',    # Unsigned Int
        relation_title_object_entity_disambig_name     => 'enriched.url.enrichedTitle.relations.relation.object.entities.entity.disambiguated.name', # Text
        relation_title_object_entity_disambig_geo      => 'enriched.url.enrichedTitle.relations.relation.object.entities.entity.disambiguated.geo',     # Text
        relation_title_object_entity_disambig_dbpedia  => 'enriched.url.enrichedTitle.relations.relation.object.entities.entity.disambiguated.dbpedia', # Text
        relation_title_object_entity_disambig_website  => 'enriched.url.enrichedTitle.relations.relation.object.entities.entity.disambiguated.website', # Text
        relation_title_object_entity_disambig_subtype  => 'enriched.url.enrichedTitle.relations.relation.object.entities.entity.disambiguated.subType', # Array
        relation_title_object_entity_disambig_subtypes => 'enriched.url.enrichedTitle.relations.relation.object.entities.entity.disambiguated.subType._subType', # Text
        relation_title_object_entity_quotations        => 'enriched.url.enrichedTitle.relations.relation.object.entities.entity.quotations',         # Array
        relation_title_object_entity_quotation         => 'enriched.url.enrichedTitle.relations.relation.object.entities.entity.quotations.quotation_.quotation', # Text
        relation_title_object_entity_quotation_sentiment_type  => 'enriched.url.enrichedTitle.relations.relation.object.entities.entity.quotations.quotation_.sentiment.type', # Text
        relation_title_object_entity_quotation_sentiment_score => 'enriched.url.enrichedTitle.relations.relation.object.entities.entity.quotations.quotation_.sentiment.type', # Float
        relation_title_object_entity_quotation_sentiment_mixed => 'enriched.url.enrichedTitle.relations.relation.object.entities.entity.quotations.quotation_.sentiment.type', # Unsigned Int
        relation_title_object_keywords                     => 'enriched.url.enrichedTitle.relations.relation.object.keywords',                         # Array
        relation_title_object_keyword                      => 'enriched.url.enrichedTitle.relations.relation.object.keywords.keyword.text',            # Text
        relation_title_object_keyword_relevance            => 'enriched.url.enrichedTitle.relations.relation.object.keywords.keyword.relevance',       # Float
        relation_title_object_keyword_sentiment_type       => 'enriched.url.enrichedTitle.relations.relation.object.keywords.keyword.sentiment.type',  # Text
        relation_title_object_keyword_sentiment_score      => 'enriched.url.enrichedTitle.relations.relation.object.keywords.keyword.sentiment.score', # Float
        relation_title_object_keyword_sentiment_mixed      => 'enriched.url.enrichedTitle.relations.relation.object.keywords.keyword.sentiment.mixed', # Unsigned Int
        relation_title_object_keyword_hierarchy            => 'enriched.url.enrichedTitle.relations.relation.object.keywords.keyword.knowledgeGraph.typeHierarchy', # Text
        relation_title_object_sentiment_type               => 'enriched.url.enrichedTitle.relations.relation.object.sentiment.type',                   # Text 
        relation_title_object_sentiment_score              => 'enriched.url.enrichedTitle.relations.relation.object.sentiment.score',                  # Float
        relation_title_object_sentiment_mixed              => 'enriched.url.enrichedTitle.relations.relation.object.sentiment.mixed',                  # Mixed
        relation_title_object_sentiment_from_subject_type  => 'enriched.url.enrichedTitle.relations.relation.object.sentimentFromSubject.type',        # Text
        relation_title_object_sentiment_from_subject_score => 'enriched.url.enrichedTitle.relations.relation.object.sentimentFromSubject.score',       # Float
        relation_title_object_sentiment_from_subject_mixed => 'enriched.url.enrichedTitle.relations.relation.object.sentimentFromSubject.mixed',       # Unsigned Int
        relation_title_location_text                       => 'enriched.url.enrichedTitle.relations.relation.location.text',                           # Text
        relation_title_location_sentiment_type             => 'enriched.url.enrichedTitle.relations.relation.location.sentiment.type',                 # Text
        relation_title_location_sentiment_score            => 'enriched.url.enrichedTitle.relations.relation.location.sentiment.score',                # Float
        relation_title_location_sentiment_mixed            => 'enriched.url.enrichedTitle.relations.relation.location.sentiment.mixed',                # Unsigned Int
        relation_title_location_entities                   => 'enriched.url.enrichedTitle.relations.relation.location.entities',                       # Array
        relation_title_location_entity                     => 'enriched.url.enrichedTitle.relations.relation.location.entities.entity.text',           # Text
        relation_title_location_entity_type                => 'enriched.url.enrichedTitle.relations.relation.location.entities.entity.type',           # Text
        relation_title_location_entity_hierarchy           => 'enriched.url.enrichedTitle.relations.relation.location.entities.entity.knowledgeGraph.typeHierarchy',           # Text
        relation_title_location_entity_count               => 'enriched.url.enrichedTitle.relations.relation.location.entities.entity.count',              # Unsigned Int
        relation_title_location_entity_relevance           => 'enriched.url.enrichedTitle.relations.relation.location.entities.entity.relevance',          # Float
        relation_title_location_entity_sentiment_type      => 'enriched.url.enrichedTitle.relations.relation.location.entities.entity.sentiment.type' ,    # Text
        relation_title_location_entity_sentiment_score     => 'enriched.url.enrichedTitle.relations.relation.location.entities.entity.sentiment.score',    # Text
        relation_title_location_entity_sentiment_mixed     => 'enriched.url.enrichedTitle.relations.relation.location.entities.entity.sentiment.mixed',    # Text
        relation_title_location_entity_disambig_name       => 'enriched.url.enrichedTitle.relations.relation.location.entities.entity.disambiguated.name', # Text
        relation_title_location_entity_disambig_geo        => 'enriched.url.enrichedTitle.relations.relation.location.entities.entity.disambiguated.geo',               # Text
        relation_title_location_entity_disambig_dbpedia    => 'enriched.url.enrichedTitle.relations.relation.location.entities.entity.disambiguated.dbpedia',           # Text
        relation_title_location_entity_disambig_website    => 'enriched.url.enrichedTitle.relations.relation.location.entities.entity.disambiguated.website',           # Text
        relation_title_location_entity_disambig_subTypes   => 'enriched.url.enrichedTitle.relations.relation.location.entities.entity.disambiguated.subType',           # Text
        relation_title_location_entity_disambig_subType    => 'enriched.url.enrichedTitle.relations.relation.location.entities.entity.disambiguated.subType.subType_',  # Text
        relation_title_entity_quotations                   => 'enriched.url.enrichedTitle.relations.relation.location.entities.entity.quotations',                      # Array 
        relation_title_entity_quotation                    => 'enriched.url.enrichedTitle.relations.relation.location.entities.entity.quotations.quotation_.quotation', # Text 
        relation_title_entity_quotation_sentiment_type     => 'enriched.url.enrichedTitle.relations.relation.location.entities.entity.quotation.quotation_.quotation.sentiment.type', # Text
        relation_title_entity_quotation_sentiment_score    => 'enriched.url.enrichedTitle.relations.relation.location.entities.entity.quotation.quotation_.quotation.sentiment.score', # Float
        relation_title_entity_quotation_sentiment_mixed    => 'enriched.url.enrichedTitle.relations.relation.location.entities.entity.quotation.quotation_.quotation.sentiment.mixed', # Unsigned Int
        relation_title_location_keywords                   => 'enriched.url.enrichedTitle.relations.relation.location.keywords',              # Array
        relation_title_location_keyword                    => 'enriched.url.enrichedTitle.relations.relation.location.keywords.keyword.text', # Text
        relation_title_location_keyword_relevance          => 'enriched.url.enrichedTitle.relations.relation.location.keywords.keyword.relevance',          # Text
        relation_title_location_keyword_sentiment_type     => 'enriched.url.enrichedTitle.relations.relation.location.keywords.keyword.sentiment_type',     # Text
        relation_title_location_keyword_sentiment_score    => 'enriched.url.enrichedTitle.relations.relation.location.keywords.keyword.sentiment_score',    # Float
        relation_title_location_keyword_sentiment_mixed    => 'enriched.url.enrichedTitle.relations.relation.location.keywords.keyword.sentiment_mixed',    # Unsigned Int
        relation_title_location_keyword_hierarchy          => 'enriched.url.enrichedTitle.relations.relation.location.keywords.keyword.knowledgeGraph.typeHierarchy', # Text
        relation_title_temporal_text                       => 'enriched.url.enrichedTitle.relations.relation.temporal.text',                                # Text
        relation_title_temporal_decoded_type               => 'enriched.url.enrichedTitle.relations.relation.temporal.decoded.type',                        # Text
        relation_title_temporal_decoded_value              => 'enriched.url.enrichedTitle.relations.relation.temporal.decoded.value',                       # Text
        relation_title_temporal_decoded_start              => 'enriched.url.enrichedTitle.relations.relation.temporal.decoded.start',                       # Text
        relation_title_temporal_decoded_end                => 'enriched.url.enrichedTitle.relations.relation.temporal.decoded.end',                         # Text
        ...
        relation_location_keywords                    => 'enriched.url.relations.relation.location.keywords',                               # Array
        relation_location_keyword                     => 'enriched.url.relations.relation.location.keywords.keyword.text',                  # Text
        relation_location_keyword_relevance           => 'enriched.url.relations.relation.location.keywords.keyword.relevance',             # Float
        relation_location_keyword_sentiment_type      => 'enriched.url.relations.relation.location.keywords.keyword.sentiment.type',        # Text
        relation_location_keyword_sentiment_score     => 'enriched.url.relations.relation.location.keywords.keyword.sentiment.score',       # Float
        relation_location_keyword_sentiment_mixed     => 'enriched.url.relations.relation.location.keywords.keyword.sentiment.mixed',       # Unsigned Int
        relation_location_keyword_sentiment_hierarchy => 'enriched.url.relations.relation.location.keywords.keyword.knowledgeGraph.typeHierarchy', # Text
        relation_temporal_text                        => 'enriched.url.relations.relation.temporal.text',                                   # Text
        relation_temporal_decoded_type                => 'enriched.url.relations.relation.temporal.decoded.type',                           # Text
        relation_temporal_decoded_start               => 'enriched.url.relations.relation.temporal.decoded.start',                          # Text
        relation_temporal_decoded_end                 => 'enriched.url.relations.relation.temporal.decoded.end',                            # Text
        sentiment_type                                => 'enriched.url.docSentiment.type',                                                  # Text
        sentiment_score                               => 'enriched.url.docSentiment.score',                                                 # Float
        sentiment_mixed                               => 'enriched.url.docSentiment.mixed',                                                 # Unsigned Int
        sentiment_title_type                          => 'enriched.url.enrichedTitle.docSentiment.type',                                    # Text
