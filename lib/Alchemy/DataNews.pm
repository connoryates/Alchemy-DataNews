...
sub get_return_fields {
    ...
    return {
        ...
        keywords_title                 => 'enriched.url.enrichedTitle.keywords',                          # Array
        keyword_title_text             => 'enriched.url.enrichedTitle.keywords.keyword.text',             # Text
        ...
        entity_title_text              => 'enriched.url.enrichedTitle.entity.text',                        # Text
